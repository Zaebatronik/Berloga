  ...
  const handleSend = async () => {
    ...
    try {
      ...
      try {
        ...
        // ✅ НЕ обновляем сообщения с сервера - используем оптимистичное обновление
        // Сообщение уже добавлено локально выше (строка 526)
        // Backend разошлет через Socket.IO другим участникам
